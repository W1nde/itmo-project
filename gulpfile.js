...
function watcher() {
    ...
    gulp.watch(path.watch.scss, scss); // gulp.series(scss, ftp) - заменить scss если хотим что бы при любом изменении сразу отправлялись на сервер. Пример: gulp.watch(path.watch.scss, gulp.series(scss, ftp));
